...
public class LeftLegPoseGUI
{
    public static final int SIZE = 54;
    public static final String TITLE = "Left Leg Pose Editor";
    ...
    {
        //弧度(Radians)
        EulerAngle pose = session.getArmorStand().getLeftLegPose();

        //轉成角度
        inventory.setItem(INFO, new ItemBuilder(Material.STICK)
                .setName("Left Leg Pose")
                .setLore("",
